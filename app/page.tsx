      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-md leading-8 text-gray-600">
            Enthusiastic, versatile and product-focused engineer. 
            Currently a production engineer at <Link className="text-orange-600 hover:text-orange-700" href="https://kaluza.com/">Kaluza</Link> on the Enablement and Release Engineering team.
          </p>
          <div className="flex">
            <Link href="https://www.linkedin.com/in/tudorharries/">
            ...
            <Link href="hhttps://github.com/TudorHarries">
